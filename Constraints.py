...
class constraints:
    ...
    def __init__(self, joints, i, theta, length, constraint_type, orientation):
        self.joints = joints
        self.i = i
        self.pi = 22 / 7
    ...
    def rotational_constraint(self):
        p_i = CG3dPoint(self.joints[self.i][0], self.joints[self.i][1],
                        self.joints[self.i][2])
        p_before = CG3dPoint(self.joints[self.i - 1][0], self.joints[self.i - 1][1],
                             self.joints[self.i - 1][2])
        p_next = CG3dPoint(self.joints[self.i + 1][0], self.joints[self.i + 1][1],
                           self.joints[self.i + 1][2])
